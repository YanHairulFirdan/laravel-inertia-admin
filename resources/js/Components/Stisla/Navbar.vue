            ...
            <div class="search-element">
                ...
                <div class="search-result">
                    ...
                    <div class="search-item">
                        {{
                            asset(
                                "stisla-master/assets/img/products/product-3-50.png"
                            )
                        }}
                        <a href="#">
                            <img
                    ...
                    <div class="search-item">
                        <a href="#">
                            <img
                                ...
                                :src="
                                    asset(
                                        'stisla-master/assets/img/products/product-2-50.png'
                                    )
                                "
                                alt="product"
                            />
                    ...
                    <div class="search-item">
                        <a href="#">
                            <img
                                ...
                                :src="
                                    asset(
                                        'stisla-master/assets/img/products/product-1-50.png'
                                    )
                                "
                                alt="product"
                            />
                        ...
                        <a href="#" class="dropdown-item dropdown-item-unread">
                            <div class="dropdown-item-avatar">
                                <img
                                    ...
                                    :src="
                                        asset(
                                            'stisla-master/assets/img/avatar/avatar-1.png'
                                        )
                                    "
                        ...
                        <a href="#" class="dropdown-item dropdown-item-unread">
                            <div class="dropdown-item-avatar">
                                <img
                                    ...
                                    :src="
                                        asset(
                                            'stisla-master/assets/img/avatar/avatar-2.png'
                                        )
                                    "
                                    class="rounded-circle"
                                />
                        ...
                        <a href="#" class="dropdown-item dropdown-item-unread">
                            <div class="dropdown-item-avatar">
                                <img
                                    ...
                                    :src="
                                        asset(
                                            'stisla-master/assets/img/avatar/avatar-3.png'
                                        )
                                    "
                                    class="rounded-circle"
                                />
                        ...
                        <a href="#" class="dropdown-item">
                            <div class="dropdown-item-avatar">
                                <img
                                    ...
                                    :src="
                                        asset(
                                            'stisla-master/assets/img/avatar/avatar-4.png'
                                        )
                                    "
                                    class="rounded-circle"
                                />
                        ...
                        <a href="#" class="dropdown-item">
                            <div class="dropdown-item-avatar">
                                <img
                                    ...
                                    :src="
                                        asset(
                                            'stisla-master/assets/img/avatar/avatar-5.png'
                                        )
                                    "
                                    class="rounded-circle"
                                />
